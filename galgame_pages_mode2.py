...
show_extra_buttons = False# 设置按钮颜色和位置大小
button_width = screen_width * 0.25
button_height = screen_height * 0.08
button_width_1 = screen_width
button_height_1 = screen_height * 0.94
...
button_color2 = (240, 240, 240)

# 计算按钮的X坐标，使其在屏幕中居中
button_x = screen_width * 0.2
button_x1 = screen_width * 0.9
...
extra_button_rect1 = pygame.Rect(0, 0, button_width_1, button_height_1)
...
while running:
    ...
    if not show_extra_buttons:
        ...
        pygame.draw.rect(screen, button_color2, extra_button_rect1, 1)
